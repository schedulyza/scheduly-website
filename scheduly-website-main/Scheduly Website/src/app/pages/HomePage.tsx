    ...
    <>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="max-w-4xl mx-auto text-center mb-16">
            ...
            <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
              Scheduly replies instantly on WhatsApp, confirms appointments, syncs calendars, and sends
                  ...
                  <div className="bg-[#0d1117] p-4 space-y-3 min-h-[400px]">
                    ...
                    <div className="flex justify-start">
                      <div className="bg-[#1f2937] rounded-2xl rounded-tl-sm px-4 py-2 max-w-[80%]">
                        <p className="text-sm">
                          Perfect! I can book you for a haircut tomorrow at 2:00 PM. Let me confirm the details:
                        </p>
      ...
      <section className="py-20 px-6 relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Effortless scheduling in 4 simple steps</h2>
            <p className="text-slate-400 text-lg">From message to confirmed appointment in seconds</p>
          </div>
            ...
            {[
              ...
              <div key={index} className="relative group">
                ...
                <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-white/20 transition-all">
                  ...
                  <div className="text-xs uppercase tracking-wider text-slate-500 mb-2">Step {item.step}</div>
      ...
      <section className="py-20 px-6 relative">
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold mb-4">Everything you need to automate scheduling</h2>
          </div>
              ...
              <div className="relative bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-8 hover:border-cyan-500/50 transition-all">
                <div className="text-center mb-8">
                  ...
                  <div className="flex items-baseline justify-center gap-2 mb-4">
                    <span className="text-5xl font-bold">R59</span>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block w-full px-8 py-4 rounded-full border-2 border-cyan-500/50 hover:border-cyan-400 transition-all font-semibold text-center text-cyan-300 hover:text-cyan-200 mb-4"
                >
                  Subscribe
                </a>
                <a
          ...
          <div className="space-y-4">
            {[
              ...
              },
              {
                ...
                answer:
                  "After your 14-day free trial, you can subscribe to continue using Scheduly at R59/month. You can cancel anytime with no penalties. If you choose not to subscribe, your service will simply stop at the end of the trial period.",
              },
              {
      ...
      <section className="py-20 px-6 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <h2 className="text-4xl md:text-6xl font-bold mb-6">Ready to automate your scheduling?</h2>
          <p className="text-xl text-slate-400 mb-10 max-w-2xl mx-auto">
